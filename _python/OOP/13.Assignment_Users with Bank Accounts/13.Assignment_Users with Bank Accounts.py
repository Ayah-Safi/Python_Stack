...
#--------------------------------------------------------------------------------------------------------------------------------  
#SENSI BONUS #SENSI BONUS #SENSI BONUS #SENSI BONUS #SENSI BONUS #SENSI BONUS #SENSI BONUS #SENSI BONUS #SENSI BONUS #SENSI BONUS
#--------------------------------------------------------------------------------------------------------------------------------
...
class User:
    ...
    def create_account(self, account_id, balance=0, interest_rate=0.01):
        self.accounts[account_id] = BankxAccount(balance, interest_rate)
        return self
